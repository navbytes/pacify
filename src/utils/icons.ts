...
export { default as CheckCheck } from 'lucide-svelte/icons/check-check'
...
export { default as AlertCircle } from 'lucide-svelte/icons/circle-alert'
export { default as CheckCircle } from 'lucide-svelte/icons/circle-check'
export {
  default as CircleQuestionMark,
  default as HelpCircle,
} from 'lucide-svelte/icons/circle-question-mark'
...
export { default as Grid3x3 } from 'lucide-svelte/icons/grid-3x3'
